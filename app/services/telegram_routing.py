...
_DECISION_VERBS = (
    ...
    "יש להתחיל", "יש לבצע", "יש לשנות", "יש לסגור", "יש לעדכן",
    "נדרש ל", "צריך ל",
    "approve", "execute", "cancel", "update", "replace",
)
_DECISION_PREFIXES = (
    "יש ל", "נדרש ל", "צריך ל", "החלטנו", "נחליט",
...
"יש להתחיל ישיבות הנהלה שבועיות"        → {"route":"decision","intent":"general","param":null}
"יש לשנות את נוהל האישורים"             → {"route":"decision","intent":"general","param":null}
