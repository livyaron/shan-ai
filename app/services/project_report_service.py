...
async def auto_send_project_report(user, session, bot=None) -> bool:
    ...
    try:
        ...
        # Audio is generated by notebooklm_worker.py running locally.
        # No video_report_service call needed.
...
async def _telegram_send_report(bot, user, report_id: int, data: dict) -> None:
    """Send report summary with inline keyboard: 📄 Report + 🎵 Listen."""
    ...
    keyboard = InlineKeyboardMarkup([[
        ...
        InlineKeyboardButton("🎵 האזן לדוח", url=f"{base}/dashboard/project-reports/{report_id}#audio-section"),
    ]])
