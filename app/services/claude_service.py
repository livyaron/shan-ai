...
כללים:
- DECISION: תיאור בעיה, פעולה נדרשת, או צומת החלטה שדורשת ניתוח — גם אם קצרה או חלקית.
- NOT_DECISION: כל אחד מהבאים:
  * ברכה, שיחה כללית, מילה בודדת
  * שאלת מידע על נתונים קיימים (כמה החלטות יש, מה הסטטוס, תן לי סיכום, כמה קריטיות וכו׳)
  * שאלות על קבצים, נהלים, מסמכים
  * כל שאלה שמתחילה ב"כמה", "מה", "מי", "מתי", "איך", "האם" ומתייחסת לנתונים קיימים
