...
async def project_reports_generate(
    ...
    # Audio is generated by notebooklm_worker.py (local service).
    # No background task needed here — worker polls DB for video_path IS NULL.
